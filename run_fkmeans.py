...
# https://www.kaggle.com/code/ysthehurricane/fuzzy-c-means-clustering-tutorial-r
# https://www.kaggle.com/code/buraaldal/bgmm-baseline-fuzzy-c-means-k-means
...
cluster_labels, cluster_centroids = clustering.apply_fkmeans(n_clusters=4)
...
# Visualize clusters
postprocessor.visualize_clusters(X_train_scaled, coords_train, cluster_labels, 'FCM Clustering', fig_settings={'figsize': (30,15)})
